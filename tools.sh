...
echo
echo $green" +----------------------+"
echo $green" + Author : R3XV        +"
echo $green" + Team   : .....       +"
echo $green" + IG     : DedeAdiGTPS +"
echo $green" +----------------------+"
echo
sleep 1
echo $green" Menu :"
echo
echo $green" [1] Kirim Virus NO TELEPON"
echo
...
echo $green
sleep 1
echo "Mengirim Virus Ke Nomor $telp"
sleep 1
echo "Mengirim Virus Ke Nomor $telp"
sleep 1
sleep 1
...
sleep 1
echo
echo $green"Berhasil Mengirim $banyak Port $port to $ip
sleep 1
echo
echo $green"Berhasil Mengirim $banyak Port $port to $ip
sleep 1
